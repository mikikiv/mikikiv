...
const Header = () => {
	...
	return (
		<div className="sticky top-0 z-50 w-full bg-primary-50/[.9] shadow-md">
			<div className="container mx-auto grid grid-cols-6 gap-4 p-2 text-text-800 lg:grid-cols-7 hover:text-text-900">
				<a
					href="/"
					className="m-auto ml-4 font-thin text-4xl transition duration-300 ease-in-out lg:col-span-2 lg:ml-24 hover:scale-105"
				>
					MV
				</a>
			</div>
